...
table(  
  ...
  // Linha 3
  [3], [02:01], img("../img/gabriel/gabriel_thumb_01_l03.png"), [(gestos icônico) Enruga a testa], [Ma... madelen... mag... (ACD)], [],
  
  // Linha 4
  [4], [02:06], [], [], [Que nome é esse? (ACC)], [Olha para o pesquisador],
  
  // Linha 5
  [5], [02:12], img("../img/gabriel/gabriel_thumb_02_l05.png"), [(gesto icônico ou pantomímico) Levanta o braço direito com punho fechado e faz um movimento em parábola para frente. Em um movimento de socar o ar.], [Tá acontecendo a maior briga... pá-pá, pá, pá! (ACD)], [],
  ...
  // Linha 8
  [8], [02:28], img("../img/gabriel/gabriel_thumb_03_l08.png"), [(gesto dêitico) Aponta com o dedo indicador], [Ai... Esse aqui não vou ler não! (AC direta)], [olha novamente para o pesquisador],
  
  // Linha 9
  [9], [03:05], img("../img/gabriel/gabriel_thumb_04_l09.png"), [], [Assistir a briga ou separa a briga?], [No final da frase, Gabriel olha para pesquisador],
  
  // Linha 10
  [10], [03:09], img("../img/gabriel/gabriel_thumb_05_l10.png"), [], [O mais correto seria separar!], [Ainda olhando para pesquisador],
  
  // Linha 11
  [11], [03:39], img("../img/gabriel/gabriel_thumb_06_l11.png"), [Mão esquerda quase fechada com o polegar estendido apontando para o próprio peito], [Se é pra fazer alguma coisa... eu separo a briga], [],
  ...
  // Linha 14
  [14], [04:28], img("../img/gabriel/gabriel_thumb_09_l14.png"), [Aponta para a seta azul], [Posso descer? É pra fazer o que? Atenção Conjunta no formato de atenção de acompanhamento], [Olha para o pesquisador],
  
  // Linha 15
  [15], [04:32], img("../img/gabriel/gabriel_thumb_10_l15.png"), [(gesto icônico) Gabriel faz um movimento com o braço direito simulando deslizar o dedo no movimento de cima para baixo.], [Agora é pra col... arrastar o dedo pra baixo], [No fim da fala ele olha para o pesquisador],
  ...
  // Linha 23
  [23], [05:09], img("../img/gabriel/gabriel_thumb_14_l23.png"), [], [Foi esse bichinho que ela viu!], [Fala do pesquisador],

  // Linha 24
  [24], [05:10], img("../img/gabriel/gabriel_thumb_15_l24.png"), [], [Parece realmente um tatu bolinha!], [(AC) Olha para o pesquisador],
  
  // Linha 25
  [25], [10:20], img("../img/gabriel/gabriel_thumb_16_l25.png"), [Expressão de aversão (gesto icônico)], [Meu Deus!], [],

  // Linha 26
  [26], [10:23], img("../img/gabriel/gabriel_thumb_17_l26.png"), [Continuação da expressão de aversão (gesto icônico)], [Que coisa horrorosa!], [],
...
table(  
  ...
  [*Plano Gestual*],[*Plano Vocal*],[*Plano do Olhar*]),
   ...
   // Linha 1
  [1], [00:00 até 24:20], img("../img/rosa/rosa_thumb_01_l01.png"), [Rosa senta-se com uma postura ereta com os braços cruzados na frente do tablet.], [], [Rosa faz varredura na tela, movendo o globo ocular para todas as direções. Ela olha para cima para baixo e para os lados da tela tentando captar o máximo de informação durante os 20 segundos iniciais da Animação.],
  
  // Linha 2
  [2], [01:43], img("../img/rosa/rosa_thumb_02_l02.png"), [Após alguns momentos, ela muda a postura apoiando seu queixo sobre as mãos, com os cotovelos apoiados na mesa. (referência de foco de atenção).], [], [],
  
  // Linha 3
  [3], [03:14], img("../img/rosa/rosa_thumb_03_l03.png"), [Rosa faz uma expressão facial com as extremidades da boca para baixo (num gesto de dúvida). 
  ...
  // Linha 5
  [5], [07:43], img("../img/rosa/rosa_thumb_05_l05g.jpg"), [sorriso "mais forte".
   (gesto emblemático)], [], [],
  
  // Linha 6
  [6], [09:01], img("../img/rosa/rosa_thumb_06_l06.png"), [Novamente Rosa fez a expressão com as extremidades da boca para baixo e levantou a mão direita para cima. (gesto emblemático)], [], [],
  
  // Linha 7
  [7], [09:44], img("../img/rosa/rosa_thumb_07_l07.png"), [gesto de estranheza após ler a descrição do Sr. Gratus (gesto emblemático)], [], [],
  
  // Linha 8
  [8], [10:46], img("../img/rosa/rosa_thumb_08_l08.png"), [Rosa gira a cabeça para direita em direção ao pesquisador e abre bem os olhos junto com a boca em um sinal de espanto com o que viu], [], [Olha para pesquisador],
  
  // Linha 9
  [9], [13:10], img("../img/rosa/rosa_thumb_09_l09.png"), [aproxima o rosto para observar um dos seres iguais ao Sr. Gratus.], [], [],
  ...
  // Linha 12
  [12], [18:17], img("../img/rosa/rosa_thumb_12_l12.png"), [expressão de estranheza novamente. (gesto emblemático)], [], [],
...
#subpar.grid(
  ...
  columns: (1fr, 1fr), // Duas colunas
  gutter: 1pt,        // Espaçamento entre os itens na Horizontal
  row-gutter: 10pt, // Espaçamento entre os itens na Vertical
  stroke: 0.0pt + luma(120), // Espessura e cor da borda
...
#subpar.grid(
  ...
  figure(image("/img/rosa/rosa_03b.png", height: 5cm), caption: [
    ...
    Comando do narrador virtual.],
       ...
       figure(image("/img/rosa/rosa_03f.png", height: 5cm), //caption: [Comando do narrador virtual.],
    ), <03f>,
...
#subpar.grid(
  figure(image("/img/rosa/rosa_03a.png", height: 5cm), caption: [Gesto facial e com as mãos de Rosa.]
    ), <04a>, 
  figure(image("/img/rosa/rosa_03b.png", height: 5cm), caption: [Gesto Icônico.],
    ), <04b>,
